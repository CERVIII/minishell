...
#    Updated: 2024/01/14 19:48:43 by fede             ###   ########.fr        #
#                                                                              #
# **************************************************************************** #
...
SRCS		= main.c lexer.c lexer_utils.c quotes.c check_utils.c parser.c utils.c cd_in.c env_in.c pwd_in.c check_builtin.c export_in.c unset_in.c echo_in.c exit_in.c
